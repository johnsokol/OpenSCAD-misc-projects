...
// Simple Test:
//projection()
gear (circular_pitch=400,gear_thickness = 10,rim_thickness = 10,hub_thickness = 10, circles=0, bore_diameter=5);
...
module build_shaft(bore_diameter , rim_thickness ,hub_thickness ,gear_thickness )
{
    intersection(){
		 cylinder (	r=bore_diameter/2,h=2+max(rim_thickness,hub_thickness,gear_thickness), $fn=200);
	...
	involute_facets=0)
{
	...
	//		h=2+max(rim_thickness,hub_thickness,gear_thickness));
     ...
     build_shaft(bore_diameter=bore_diameter, rim_thickness=rim_thickness,hub_thickness=hub_thickness,gear_thickness=gear_thickness  );
